...
void packetOperation::packetCapture(int loopcount){
    ...
    if(controlOpen!=true){
        ...
        this->searchMap->updateMap(this->sessionMap,true,this->packets,this->headers);
...
void packetOperation::createSessionMap(const PacketInfo &p){
    std::cout << "createSessionMap " << this->pCount << std::endl;
    ...
    if(isFound!=true){
        sessionMap[searchString.front()] = {p.sourceIP,
                                             p.destIP,
                                             p.sourcePort,
                                             p.destPort,
                                             this->streamIndex,
